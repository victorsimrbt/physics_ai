...
class App:
    def __init__(self,gif_path = 'joint1.gif',draw=True,steps = 100,gif_len = 100):
    ...
    def run(self,functions = None,steps = 100):
        comp_steps = 0
    ...
    def make_gif(self):
        if self.gif > 0:
            ...
            self.gif -= 1
            if self.gif == 0:
                self.images[0].save(self.gif_path,
